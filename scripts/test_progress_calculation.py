...
def test_official_roadmap():
    ...
    assert metrics["active_step"]["num"] == "00", f"Étape active initiale attendue: 00, Obtenu: {metrics['active_step']['num']}"
    print(f"  -> Succès : 31 étapes officielles chargées, {metrics['total_subtasks']} sous-tâches uniques valides.")
